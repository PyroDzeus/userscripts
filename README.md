...
Small browser add-ons that make the Plex web app more useful: quick links to film databases, one-click playback in your own video player, awards shown on each film's page, a random-pick wheel and a custom look.
