...
| **Plex NFO Viewer 📄** | Shows the `.nfo` of a film, series, season or episode in Plex, like Jellyfin does. Needs a small companion server: [setup guide](docs/plex-nfo-viewer.md) | [Install](https://raw.githubusercontent.com/PyroDzeus/userscripts/main/plex-nfo-viewer.user.js) |
